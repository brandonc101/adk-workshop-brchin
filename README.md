...
| [ChallengeLab4](./ChallengeLab4) | Answer-team workflow — a coordinator routes to a greeter or a Sequential answer team (search → critique → refine) that answers, verifies, and refines responses. |
