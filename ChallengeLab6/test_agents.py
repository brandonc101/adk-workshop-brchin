...
# Load readynow_agent/.env (Maps key not needed here; model + Model Armor settings).
load_dotenv("readynow_agent/.env")

from google.adk.runners import Runner  # noqa: E402
from google.adk.sessions import InMemorySessionService  # noqa: E402
from google.genai import types  # noqa: E402

from readynow_agent.agent import root_agent  # noqa: E402
...
QUERIES = [
    ("CAPABILITIES", "Hi, what can you do?"),
    ("WEATHER", "What's the current weather in Miami, FL? Any alerts?"),
    ("NEWS/SEARCH", "Are there any current severe weather warnings in the US right now?"),
    ("ROUTE", "I'm in Sacramento, CA. Driving directions to UC Davis Medical Center?"),
    ("OFF-MISSION", "Write me a poem about my cat."),
]
