"""Deploy the readynow_agent multi-agent system to Vertex AI Agent Engine.
...
def main() -> None:
    ...
    remote_app = agent_engines.create(
        ...
        description=(
            "ReadyNow! emergency-preparedness assistant: weather, news/search, "
            "routes to safety, and a research -> critique -> refine answer team."
        ),
